...
def mock_mismatched_pbt_directory(tmp_path):
    ...
    file1 = {
        "generation_history": [
            {
                "worker_configs": [{"worker_id": 0, "config": {"a": 1}}],
                "worker_scores": [
                    {
                        "worker_id": 0,
                        "score": 1,
                        "metrics": {"throughput": 1, "failure_type": None},
                    }
                ],
            }
        ]
    ...
    file2 = {
        "generation_history": [
            {
                "worker_configs": [{"worker_id": 0, "config": {"a": 1, "b": 2}}],
                "worker_scores": [
                    {
                        "worker_id": 0,
                        "score": 1,
...
def test_load_pbt_results_empty_history(tmp_path):
    ...
    data_dir.mkdir()
    (data_dir / "pbt_results_empty.json").write_text(
        json.dumps(
            {
                "tuning_session": {
                    "workload_type": "oltp",
