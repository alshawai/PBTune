...
(PBT, LHS-design, and BO). All three have been migrated onto this framework and
the legacy ``src/tuner`` and ``src/scripts/bo_baseline`` packages removed. See
ADR-006 and its 2026-07-17 addendum.
"""
